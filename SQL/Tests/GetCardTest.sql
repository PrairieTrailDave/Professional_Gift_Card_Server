-- ***************************************************************************
--
--  Copyright (c) 2015 Prairie Trail Software, Inc.
--  All rights reserved.
--
-- ***************************************************************************
...
EXECUTE gp_GetCard @PhoneNumber, @MerchantGUID1, @ErrorCode OUTPUT, @CardGUID OUTPUT, @EncryptedFirstName OUTPUT, @EncryptedLastName OUTPUT;
...
SET @MerchantGUID6 = NEWID();
INSERT INTO Merchant (MerchantID, MerchantGUID,     MerchantName,  Address1, City, State, PostalCode, Phone,       TimeZone, LastSeqNumber, GiftActive, LoyaltyActive, PaidUpTo)
            values (@MerchantID6, @MerchantGUID6, 'Test Merchant 6', 'Adr1', 'City', 'ST', '12345',  '9725551212', 'Central', 1,            'Y',        'Y', DATEADD(month, 1, SYSDATETIME()));
...
EXECUTE gp_GetCard @PhoneNumber, @MerchantGUID6, @ErrorCode OUTPUT, @CardGUID OUTPUT, @EncryptedFirstName OUTPUT, @EncryptedLastName OUTPUT;
IF @ErrorCode <> 'NOTVL' GOTO TestFailed
...
UPDATE [Cards] SET [MerchantGUID] = @MerchantGUID1 WHERE CardNumber = @CardNumber3;
